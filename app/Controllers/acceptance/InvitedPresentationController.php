...
class InvitedPresentationController extends AcceptanceController
{

    public function invited_presentation_acceptance($abstract_id)
    {
        ...
        return
            ...
            view('acceptance/invited_presentation/speaker_acceptance', $data) .
            view('acceptance/common/footer');
    }


    public function invited_presentation_acceptance_menu($abstract_id)
    {
        ...
        return
            view('acceptance/common/header', $header_data) .
            view('acceptance/invited_presentation/acceptance_menu', $data) .
            view('acceptance/common/footer');
    }
...
//        print_R($abstract_schedule);exit;
    ...
    public function invited_presentation_finalize($abstract_id){
        ...
        return
            view('acceptance/common/header', $header_data).
            view('acceptance/invited_presentation/speaker_acceptance_finalize', $data).
            view('acceptance/common/footer')
            ;
