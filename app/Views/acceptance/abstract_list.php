                ...
                <table id="resourcesTableBody" class="table ">
                    ...
                    <tbody id="resourcesTableBody">
                        <tr>
                            ...
                            <td></td>
                            <td><a href="https://www.srs.org/Meetings-Conferences/IMAST/IMAST2027" target="_blank" class="btn btn-success btn-sm w-100"> Open </a></td>
                        </tr>
                    </tbody>
                </table>
            </div>
...
<script>
    ...
    $(function(){
        ...
        $("#abstractTableBody").on('click', '.openBtn', function(){
            ...
            if ([3, 4, 5, 6].includes(parseInt(acceptance_type))) {
