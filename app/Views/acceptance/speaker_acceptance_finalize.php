    ...
    <div class="card mt-2">
        ...
        <div class="card-body" style="line-height: 30px">
            <div class="row">
                ...
                <div class="col-7">
                    <?= isset($author_acceptance) && $author_acceptance['acceptance_confirmation'] == 1 ? "Yes, I plan to present at the 34th IMAST held April 7-9, 2027 in Copenhagen, Denmark." : '' ?>
                    <?= isset($author_acceptance) && $author_acceptance['acceptance_confirmation'] == 2 ? "No, I am unable to present at the 34th IMAST held April 7-9, 2027 in Copenhagen, Denmark." : '' ?>
                </div>
                <div class="col-1">
                ...
                <?php if($author_acceptance['acceptance_confirmation'] == 1): ?>
                    <div class="col-4 text-end fw-bolder">Manuscript Upload: </div>
                    ...
                    <div class="col-1">
                        <span class="float-end"><a class="editBtn btn btn-primary py-0" href="<?=base_url() ?>/acceptance/manuscript/<?= $abstract_id ?>"><i class="fas fa-edit"></i> Edit</a></span>
                    </div>
                <?php endif ?>
