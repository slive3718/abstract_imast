    ...
    <div class="card mt-2">
        ...
        <div class="card-body" style="line-height: 30px">
            <div class="row">
                ...
                <div class="col-7">
                    <?= isset($author_acceptance) && $author_acceptance['acceptance_confirmation'] == 1 ? "I plan to present at the 34th IMAST held April 7-9, 2027 in Copenhagen, Denmark." : '' ?>
                    <?= isset($author_acceptance) && $author_acceptance['acceptance_confirmation'] == 2 ? "I am unable to present at the 34th IMAST held April 7-9, 2027 in Copenhagen, Denmark." : '' ?>
                </div>
                <div class="col-1">
