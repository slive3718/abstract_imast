...
<body>
<?php //print_r($admin_acceptance);exit; ?>
<div class="container">
    <?= view('acceptance/eposter/menu_shortcut'); ?>
...
<script>
    ...
    $(function() {
        ...
        $('button[type="submit"]').on('click', function(e) {
            ...
            $.ajax({
                url: acceptanceBaseUrl + 'save_e_poster_acceptance_confirmation', // Your server-side endpoint
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
    ...
    function goNext(abstract_id){
        window.location.href = acceptanceBaseUrl+'e_poster_acceptance_finalize/'+abstract_id
    }
