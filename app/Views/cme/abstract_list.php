...
<script>
    ...
    $(function(){
        ...
        $("#abstractTableBody").on('click', '.reviewBtn', function(){
            ...
            window.location.href= baseUrlReviewer+"reviewCMEAbstract/"+abstract_id;
        })
    ...
    function getAbstracts(){
        ...
        $.post(baseUrlReviewer+'getCMEPapersToReview', function(response){
            ...
            $.each(shuffledData, function(i, val){
                ...
                $('#abstractTableBody').append('<tr>'+
                    ...
                    '<td id="rating_'+val.abstracts.id+'">'+(val.is_rated && val.is_rated !== 'No' ? val.is_rated : '')+'</td>'+
