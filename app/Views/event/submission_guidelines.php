        ...
        <div class="card">
            ...
            <div class="row mt-4">
                <div class="col justify-content-center text-center ">
                    <button onClick="window.location.href='<?=base_url()?>'" class="glass-button w-700  btn btn-primary btn-lg align-center" type="button">Submit Or Update Abstract</button>
                </div>
            </div>
